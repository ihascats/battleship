...
/***/ "./src/js/board.drag-orientation.js":
/*!******************************************!*\
  !*** ./src/js/board.drag-orientation.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _board_update_player_map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./board.update-player-map */ \"./src/js/board.update-player-map.js\");\n// eslint-disable-next-line import/no-cycle\n\n\nfunction getChildElementIndex(node) {\n  return Array.prototype.indexOf.call(node.parentNode.children, node);\n}\n\nfunction dragOrientation(orientation, element, imgH, imgV, player, id) {\n  var row = 0;\n  var column = 0;\n  var squares = document.querySelectorAll('.square');\n  var shipSquare = element; //\n  //\n\n  var a = function a() {//\n  };\n\n  if (orientation) {\n    shipSquare.ondragstart = function (e) {\n      e.dataTransfer.setDragImage(imgH, 24, 24);\n      squares.forEach(function (elementSquare) {\n        var square = elementSquare;\n\n        square.ondragenter = function (event) {\n          event.preventDefault();\n          var elementNumber = getChildElementIndex(square);\n          row = Math.floor(elementNumber / 10);\n          column = elementNumber % 10;\n\n          a = function a() {\n            player.map.positionShip(player.map.ships[id], [row, column]);\n          };\n        };\n      });\n    };\n  }\n\n  if (!orientation) {\n    shipSquare.ondragstart = function (e) {\n      e.dataTransfer.setDragImage(imgV, 24, 24);\n      squares.forEach(function (elementSquare) {\n        var square = elementSquare;\n\n        square.ondragenter = function (event) {\n          event.preventDefault();\n          var elementNumber = getChildElementIndex(square);\n          row = Math.floor(elementNumber / 10);\n          column = elementNumber % 10;\n\n          a = function a() {\n            player.map.positionShip(player.map.ships[id], [row, column]);\n          };\n        };\n      });\n    };\n  }\n\n  shipSquare.ondragend = function () {\n    a();\n    (0,_board_update_player_map__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(player);\n  };\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (dragOrientation);\n\n//# sourceURL=webpack://linting/./src/js/board.drag-orientation.js?");
...
/***/ "./src/js/board.ship-class-assign.js":
/*!*******************************************!*\
  !*** ./src/js/board.ship-class-assign.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _board_drag_orientation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./board.drag-orientation */ \"./src/js/board.drag-orientation.js\");\n/* harmony import */ var _board_update_player_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./board.update-player-map */ \"./src/js/board.update-player-map.js\");\n // eslint-disable-next-line import/no-cycle\n\n\n\nfunction assignClass(shipIdNumber, player, playerBoard, row, column) {\n  var i = row;\n  var j = column;\n  var board = playerBoard;\n  var shipType = ['carrier', 'battleship', 'cruiser', 'submarine', 'destroyer'];\n\n  for (var iteration = 0; iteration < 5; iteration += 1) {\n    if (shipIdNumber === iteration) {\n      (function () {\n        var horizontal = document.createElement('img');\n        horizontal.src = \"../src/img/\".concat(shipType[iteration], \"Horizontal.png\");\n        var vertical = document.createElement('img');\n        vertical.src = \"../src/img/\".concat(shipType[iteration], \"Vertical.png\");\n        var shipId = shipIdNumber;\n        var orientation = player.map.ships[shipId].orientation;\n        board.children.item(i * 10 + j).classList.add(shipType[iteration]);\n        board.children.item(i * 10 + j).draggable = true;\n        (0,_board_drag_orientation__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(orientation, board.children.item(i * 10 + j), horizontal, vertical, player, shipId);\n\n        board.children.item(i * 10 + j).onclick = function () {\n          //\n          player.map.rotateShip(player.map.ships[shipId]);\n          (0,_board_update_player_map__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(player);\n        };\n      })();\n    }\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (assignClass);\n\n//# sourceURL=webpack://linting/./src/js/board.ship-class-assign.js?");

/***/ }),

/***/ "./src/js/board.update-player-map.js":
/*!*******************************************!*\
  !*** ./src/js/board.update-player-map.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _board_ship_class_assign__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./board.ship-class-assign */ \"./src/js/board.ship-class-assign.js\");\n// eslint-disable-next-line import/no-cycle\n\n\nfunction updateUserBoard(player) {\n  //\n  var board = document.querySelector('.board');\n  board.childNodes.forEach(function (element) {\n    var square = element;\n\n    while (square.classList.length > 1) {\n      square.classList.remove(square.classList[square.classList.length - 1]);\n    }\n\n    square.draggable = false;\n    square.ondragstart = null;\n  });\n\n  for (var i = 0; i < 10; i += 1) {\n    for (var j = 0; j < 10; j += 1) {\n      if (typeof player.map.layout[i][j] === 'number') {\n        board.children.item(i * 10 + j).classList.add('ship');\n        (0,_board_ship_class_assign__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(player.map.layout[i][j], player, board, i, j);\n      }\n    }\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (updateUserBoard);\n\n//# sourceURL=webpack://linting/./src/js/board.update-player-map.js?");
