...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/styles.css */ \"./src/css/styles.css\");\n/* harmony import */ var _board_generate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./board.generate */ \"./src/js/board.generate.js\");\n/* harmony import */ var _board_randomize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./board.randomize */ \"./src/js/board.randomize.js\");\n/* harmony import */ var _board_randomize_on_load__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./board.randomize-on-load */ \"./src/js/board.randomize-on-load.js\");\n/* harmony import */ var _player_constructor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./player.constructor */ \"./src/js/player.constructor.js\");\n\n\n\n\n\n(0,_board_generate__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\nvar cpu = new _player_constructor__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\nvar player = new _player_constructor__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n\nwindow.onload = function () {\n  return (0,_board_randomize_on_load__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(player, cpu);\n};\n\n(0,_board_randomize__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(player);\ncpu.designateOpponent(player);\nplayer.designateOpponent(cpu);\nvar opponentBoard = document.querySelector('#opponent');\nvar playerBoard = document.querySelector('.board');\n\nfunction getChildElementIndex(node) {\n  return Array.prototype.indexOf.call(node.parentNode.children, node);\n}\n\nopponentBoard.onclick = function (e) {\n  var square = e.target.closest('.square');\n  if (!square || square === null) return;\n  var elementNumber = getChildElementIndex(square);\n  var row = Math.floor(elementNumber / 10);\n  var column = elementNumber % 10;\n\n  if ( // eslint-disable-next-line operator-linebreak\n  cpu.map.layout[row][column] !== false && cpu.map.layout[row][column] !== true) {\n    player.attack([row, column]);\n    var cpuAttack = true;\n\n    while (cpuAttack) {\n      var cord0 = Math.floor(Math.random() * 10);\n      var cord1 = Math.floor(Math.random() * 10);\n\n      if ( // eslint-disable-next-line operator-linebreak\n      player.map.layout[cord0][cord1] !== false && player.map.layout[cord0][cord1] !== true) {\n        cpu.attack([cord0, cord1]);\n        cpuAttack = false;\n      }\n    }\n  }\n\n  for (var i = 0; i < 10; i += 1) {\n    for (var j = 0; j < 10; j += 1) {\n      if (cpu.map.layout[i][j] === true) {\n        opponentBoard.children.item(i * 10 + j).classList.add('hit');\n      }\n\n      if (cpu.map.layout[i][j] === false) {\n        opponentBoard.children.item(i * 10 + j).classList.add('miss');\n      }\n    }\n  }\n\n  for (var _i = 0; _i < 10; _i += 1) {\n    for (var _j = 0; _j < 10; _j += 1) {\n      if (player.map.layout[_i][_j] === true) {\n        playerBoard.children.item(_i * 10 + _j).classList.add('hit');\n      }\n\n      if (player.map.layout[_i][_j] === false) {\n        playerBoard.children.item(_i * 10 + _j).classList.add('miss');\n      }\n    }\n  }\n};\n\n//# sourceURL=webpack://linting/./src/js/index.js?");
